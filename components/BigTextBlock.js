  ...
  return (
    <section className={'big-text-container'}>
      <h2 className={'primary-heading'}>
        We found the biggest problem with our clients is that they want the most amount of awareness
        and leads for the lowest possible price in the shortest possible timeframe.
      </h2>
